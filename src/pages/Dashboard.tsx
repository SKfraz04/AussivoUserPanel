        ...
        <main className="p-6">
          <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-4 mb-8">
              ...
              <TabsTrigger value="staking">Active Staking</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="buy-tokens" className="space-y-8">
              <div>
          ...
          {/* Recent Activity and Announcements - Only show on overview tab */}
          {activeTab === "overview" && (
